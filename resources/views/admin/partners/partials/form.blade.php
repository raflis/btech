...
<div class="form-group col-sm-12">
  {!! Form::label('image','Selecciona una imagen:',['class'=>'mt-3']) !!} <strong>(125px de ancho)</strong><code>*</code>
  <div class="input-group">
      ...
      {!! Form::text('image',null,['class'=>'form-control','id'=>'thumbnail_']) !!}
  </div>
<div id="holder_" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="partners.edit")
        <img src="{{ $partner->image }}" alt="" style="height:5rem">
    @endif
</div>
</div>
...
<div class="px-3 col-sm-12 mb-3">
  <div class="card shadow col-sm-12 px-0">
      ...
      <h6 class="m-0 font-weight-bold text-primary float-left">Soluciones:</h6>
      ...
      <div class="texto pt-4">
          @if (Route::currentRouteName()=="partners.create")
          <div class="card-body">
          {!! Form::label('items','Nombre:',['class'=>'']) !!} <code>*</code>
          {!! Form::text('items[0][name]',null,['class'=>'form-control','required']) !!}

          {!! Form::label('items','Descripción:',['class'=>'mt-3']) !!} <code>*</code>
          {!! Form::text('items[0][description]',null,['class'=>'form-control','required']) !!}

          {!! Form::label('items','Link:',['class'=>'mt-3']) !!} <code>*</code>
          {!! Form::text('items[0][link]',null,['class'=>'form-control','required']) !!}
          ...
          <div class="card-body">
              ...
              {!! Form::label('items','Descripción:',['class'=>'mt-3']) !!} <code>*</code>
              {!! Form::text('items['.$loop->index.'][description]',$item['description'],['class'=>'form-control','required']) !!}

              {!! Form::label('items','Link:',['class'=>'mt-3']) !!} <code>*</code>
              {!! Form::text('items['.$loop->index.'][link]',$item['link'],['class'=>'form-control','required']) !!}
  
              {!! Form::label('items','Selecciona una imagen',['class'=>'mt-3']) !!} <small><strong>(485 x 260px)</strong></small> <code>*</code>
              <div class="input-group">
                  <span class="input-group-btn">
      ...
      @endif
		$('.añadir').on('click',function(e){
			...
			var template='<div class=""><div class="card-body pt-0">' +
                ...
                '<label for="items" class="mt-3">Descripción:</label> <code>*</code>' +
								'<input class="form-control" name="items['+i+'][description]" type="text" required>' +
                '<label for="items" class="mt-3">Link:</label> <code>*</code>' +
								'<input class="form-control" name="items['+i+'][link]" type="text" required>' +
                '<label for="items" class="mt-3">Selecciona una imagen:</label> <small><strong>(485 x 260px)</strong></small> <code>*</code>' +
                '<div class="input-group">' +
                  '<span class="input-group-btn">' +
