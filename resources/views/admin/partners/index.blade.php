    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-user-shield fa-xs text-white2"></i> Partners
                </h1>
                <span class="subtitle">
                    Crear, editar y eliminar partners.
                </span>
            </div>
        </div>
        <div class="row layout-body">
            <div class="col-sm-12">
                    ...
                    <table class="table tableD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ $partner->image }}" alt="" height=35></td>
                                <td>{{ $partner->name }}</td>
                                <td>{{ $partner->order }}</td>
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('partners.edit', $partner->id) }}">
                                            <i class="far fa-edit pr-1"></i> Editar
                                        </a>
                                        <a class="btn btn-danger btn-sm btn-eliminar" href="" ideliminar="{{ $partner->id }}"><i class="far fa-trash-alt pr-1"></i> Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $partners->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['partners.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('partners.destroy', '') }}';
        var url = base + '/' +id;
